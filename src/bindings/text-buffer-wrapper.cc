...
void TextBufferWrapper::init(Local<Object> exports) {
  ...
  Nan::SetTemplate(prototype_template, Nan::New("_load").ToLocalChecked(), Nan::New<FunctionTemplate>(load), None);
  Nan::SetTemplate(prototype_template, Nan::New("_baseTextMatchesFile").ToLocalChecked(), Nan::New<FunctionTemplate>(base_text_matches_file), None);
  Nan::SetTemplate(prototype_template, Nan::New("_save").ToLocalChecked(), Nan::New<FunctionTemplate>(save), None);
  ...
  Nan::SetTemplate(prototype_template, Nan::New("_find").ToLocalChecked(), Nan::New<FunctionTemplate>(find), None);
  Nan::SetTemplate(prototype_template, Nan::New("_findSync").ToLocalChecked(), Nan::New<FunctionTemplate>(find_sync), None);
  Nan::SetTemplate(prototype_template, Nan::New("_findAll").ToLocalChecked(), Nan::New<FunctionTemplate>(find_all), None);
  Nan::SetTemplate(prototype_template, Nan::New("_findAllSync").ToLocalChecked(), Nan::New<FunctionTemplate>(find_all_sync), None);
  ...
  Nan::SetTemplate(prototype_template, Nan::New("_findWordsWithSubsequenceInRange").ToLocalChecked(), Nan::New<FunctionTemplate>(find_words_with_subsequence_in_range), None);
